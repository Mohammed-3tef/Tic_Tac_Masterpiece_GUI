...
bool wordGame::isWin() {
    ...
    ui->xx10->setStyleSheet("hover:color:#fff;");
    ui->xx11->setStyleSheet("hover:color:#fff;");
    ui->xx12->setStyleSheet("hover:color:#fff;");
    ui->xx13->setStyleSheet("hover:color:#fff;");
    ui->xx14->setStyleSheet("hover:color:#fff;");
    ui->xx15->setStyleSheet("hover:color:#fff;");
    ui->xx16->setStyleSheet("hover:color:#fff;");
    ui->xx17->setStyleSheet("hover:color:#fff;");
    ui->xx18->setStyleSheet("hover:color:#fff;");
    ui->xx19->setStyleSheet("hover:color:#fff;");
    ui->xx20->setStyleSheet("hover:color:#fff;");
    ui->xx21->setStyleSheet("hover:color:#fff;");
    ui->xx22->setStyleSheet("hover:color:#fff;");
    ui->xx23->setStyleSheet("hover:color:#fff;");
    ui->xx24->setStyleSheet("hover:color:#fff;");
    ui->xx25->setStyleSheet("hover:color:#fff;");
    ui->xx26->setStyleSheet("hover:color:#fff;");
